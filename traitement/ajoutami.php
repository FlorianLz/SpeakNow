    ...
    if (isset($_POST['idAmi']) && !empty($_POST['idAmi']) && isset($_SESSION['id'])){
        ...
        if(isset($_POST['idami']) && isset($_POST['page']) && isset($_POST['action'])){
            ...
            if($_POST['page'] == 'recherche'){
                ...
                echo '<div><i class="far fa-smile"></i><p> Vous êtes amis</p></div>';
                echo '<button class="actionami" data-action="supprimer" data-idami="'.$idAmi.'" data-page="recherche">Supprimer</button>';
            }
        }
    }
